...
int main()
{
    ...
    //blockInit(h_V1, Grid_Width, Grid_Height, PREY);
    //blockInit(h_V2, Grid_Width, Grid_Height, PREDATOR);
    
	randomInit(h_V1, Grid_Width, Grid_Height, PREY);
	randomInit(h_V2, Grid_Width, Grid_Height, PREDATOR);
